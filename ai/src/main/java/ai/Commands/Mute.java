...
public class Mute {
    ...
    public static void handleMuteCommand(SlashCommandInteraction interaction, ServerSettings settings) throws DocumentUnavailableException {
    ...
    public static void handleUnmuteCommand(SlashCommandInteraction interaction, ServerSettings settings) throws DocumentUnavailableException {
        interaction.getServer().get().createUpdater()
            ...
            if (settings.isModLogEnabled() && settings.isLogMuteEnabled() && settings.getLogChannelID() != null) {
